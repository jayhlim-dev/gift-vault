...
export function invalidateFirebaseCollectionCache(collection) {
...
export function invalidateFirebaseCollectionCaches(collections) {
    collections.forEach(invalidateFirebaseCollectionCache);
}
